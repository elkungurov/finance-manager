...
{
  "credits": [
    {"id": "uuid", "name": "Ипотека", "total": 5000000, "monthly": 45000, "day": 15}
  ],
  "payments": {
    "creditId": {
...
- `paid` — оплачено вовремя или после даты платежа (зелёный)
- `early` — оплачено досрочно (жёлтый)
- отсутствует — не оплачено (красный, если дата уже прошла)

## Логика календаря

- День платежа = `credit.day` число каждого месяца
- На календаре под числом — цветные точки (по одной на кредит)
- Будущие непогашенные платежи — серые точки
- Прошедшие непогашенные — красные
